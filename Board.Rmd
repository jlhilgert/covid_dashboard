...
runtime: shiny
resource_files:
- COVID-19-geographic-disbtribution-worldwide-2020-12-14.xlsx
---
...
dateInput("date_adjust", label = "Select date:",
            min = min(OWIDdata$date), max = max(OWIDdata$date), value = as.character(max(OWIDdata$date)), startview = "year")
