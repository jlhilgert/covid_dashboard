...
dt2 <- OWIDdata %>%
  ...
  select(location, date, total_cases, new_cases_smoothed, incidence, cases_smoothed_diff_avg, total_deaths, new_deaths_smoothed, deaths_smoothed_diff_avg)
...
dt4 <- OWIDdata2 %>%
  ...
  select(location, total_cases, new_cases_smoothed, cases_smoothed_diff_avg, incidence, total_deaths, new_deaths_smoothed, deaths_smoothed_diff_avg)
